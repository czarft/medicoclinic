	...
	RoyalSlider.prototype = {
						...
						if (this._dw4() !== -this.currentSlideId * this.slideWidth) {
							this._ev.bind("webkitTransitionEnd.rs", function(e) {
								if (e.target == g._ev.get(0)) {
									console.log ('409: webkitTransitionEnd')
					...
					if (!this._cx2) {
						...
						setTimeout(function() {
							k.bind("webkitTransitionEnd.rs", function(e) {
								console.log ('451: webkitTransitionEnd');
								if (e.target == k.get(0)) {
		...
		_mn3 : function() {
			...
			this._ev.bind(this._az, function(e) {
				console.log ('772: this._az');
				console.log (a.hasTouch);
				console.log (a._gt1);
				if (!a._gt1) {
					a._dw5(e)
				} else if (!a.hasTouch) {
		...
		_dw5 : function(e) {
			if (!this._az2) {
				...
				$(document).bind(this._by, function(e) {
					console.log ('847: this._az');
					c._gt5(e)
				});
				$(document).bind(this._cx, function(e) {
					console.log ('851: this._az');
					c._hs5(e)
				});
				if (!this._ir) {
